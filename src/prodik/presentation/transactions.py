...
from prodik.presentation.schemas.transactions import UploadTransactionRequest, UploadTransactionResponse
from prodik.application.transaction.command import UploadTransactionInteractor, UploadTransactionRequestDTO
...
async def upload_transaction(
    ...
    result = await upload_transaction_interactor.execute(UploadTransactionRequestDTO(
